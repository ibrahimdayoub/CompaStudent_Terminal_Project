    ...
    return(
        ...
        <nav className="border border-primary border-5 border-top-0 border-bottom-0 border-end-0 navbar navbar-expand-lg navbar-dark bg-dark shadow sticky-top">
            <div className="container-fluid">
                <Link className="navbar-brand" to="/teacher">CompaStudent</Link>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav ms-auto mb-md-0">
                        <li className="nav-item me-1 " title="Home">
                            <Link className="nav-link" to="/teacher/home"> <i className="fa fa-home fa-2x"></i><span className="fs-5 ms-2 d-inline d-lg-none">Home</span></Link>
                        </li>
                        <li className="nav-item me-1 " title="Programs">
                            <Link className="nav-link" to="/teacher/view_programs"><i className="fa fa-receipt fa-2x"></i><span className="fs-5 ms-2 d-inline d-lg-none">Programs</span></Link>
                        </li>
                        <li className="nav-item me-1" title="Events" onClick={()=>setCountEvents(0)}>
                            <Link className="nav-link position-relative" to="/teacher/events">
                        ...
                        <li className="nav-item me-1" title="Profile">
                            <Link className="nav-link" to="/teacher/profile"><i className="fa fa-user fa-2x"></i><span className="fs-5 ms-2 d-inline d-lg-none">Profile</span></Link>
                        </li>
