...
const UpdateStudent =(props)=>{
    ...
    const studentUpdate=(e)=>{
        ...
        axios.put(`/api/update_student/${id}`,data).then(res=>{
            ...
            {   
                ...
                history.push('/admin/view_students');
            }
    ...
    useEffect(()=>{
        let flag=0;
        (async () => {
            await axios.get(`/api/view_student/${id}`).then(res=>{
                if(res.data.status===200)
                {
    ...
    else if(loading)
    {
        return (
            <div className="container px-4 py-4 text-primary">
                <span className="h1 my-4">Update Student </span>
    ...
    return(
        <div className="container px-4">
            <h1 className="my-4 d-none d-md-block">Update Student</h1>
            <i className="my-4 fa fa-edit fa-3x d-md-none text-primary"></i> 

            <form onSubmit={studentUpdate} className="my-5">     
                    ...
                    <div className="card-body border pt-5">
                        ...
                        <div className="form-check mb-3 offset-md-1 col-md-10">
                            ...
                            <label className="form-check-label" htmlFor="reset_password" className={isChecked==="0"?"text-dark":"text-primary"}>
                                I Would Reset Password For This Student
                            </label>
                        </div>
                ...
                <div className="row mt-4">
                    <div className="d-grid">
                        <button type="submit" className="btn btn-primary btn-block py-3 offset-md-1 col-md-10">Update Student</button>
                    </div>
                </div>
            </form>
        </div>
