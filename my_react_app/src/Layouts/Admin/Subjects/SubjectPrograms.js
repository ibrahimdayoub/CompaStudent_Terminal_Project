...
const SubjectPrograms =(props)=>{
    ...
    useEffect(()=>{
        axios.get(`/api/subject_programs/${id}`).then(res=>{
    ...
    else if(loading)
    {
        return (
            <div className="container px-4 py-4 text-primary">
                <span className="h1 my-4">Subject Programs </span>
    ...
    return(
            ...
            <h1 className="my-4"> <span className="d-none d-md-inline">Subject Programs</span> <i className="fa fa-receipt fa-2x d-md-none text-primary"></i> <Link className="btn btn-sm btn-primary px-4 m-1 ms-auto float-end" to="/admin/view_subjects" role="button"><i className="fa fa-chevron-right"></i></Link></h1>
            ...
            <div className=" mb-3 offset-md-3 col-md-6 text-center">
                <p className="fs-6">
                   ...
                   <span className="text-primary"> {programs[0].subject.name}</span> 
                   <br/>
...
export default SubjectPrograms;