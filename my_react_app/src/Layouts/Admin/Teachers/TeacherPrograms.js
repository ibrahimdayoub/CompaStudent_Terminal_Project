...
const TeacherPrograms =(props)=>{
    ...
    useEffect(()=>{
        axios.get(`/api/teacher_programs/${id}`).then(res=>{
    ...
    else if(loading)
    {
        return (
            <div className="container px-4 py-4 text-primary">
                <span className="h1 my-4">Teacher Programs </span>
        ...
        programsTable=programs.map((program,idx)=>{
            return(
                <tr key={idx}>
                    ...
                    <td className="py-2 text-center">{program.subject.name}</td>
    ...
    return(
            ...
            <h1 className="my-4"> <span className="d-none d-md-inline">Teacher Programs</span> <i className="fa fa-receipt fa-2x d-md-none text-primary"></i>  <Link className="btn btn-sm btn-primary px-4 m-1 ms-auto float-end" to="/admin/view_teachers" role="button"><i className="fa fa-chevron-right"></i></Link></h1>
            ...
            <div className=" mb-3 offset-md-3 col-md-6 text-center">
                <p className="fs-6">
                   ...
                   <span className="text-primary"> {programs[0].subject.teacher.first_name} {programs[0].subject.teacher.middle_name}  {programs[0].subject.teacher.last_name}  </span> 
                   <br/>
